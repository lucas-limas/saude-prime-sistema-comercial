...
window.SP_DATA = [
  ...
  // ── PLENUM SAÚDE ──────────────────────────────────────────────────────
  {
    ...
    produtos: [
      ...
      { id:'pp_cc99_1', nome:'Com copart — Delta',  aco:'enf', tipo:'pme', fvidas:'30-99', valores:[199.95,249.95,289.93,329.92,359.91,379.91, 459.89, 499.88, 619.85, 959.76] },
  ...
  // ── AMIL ──────────────────────────────────────────────────────────────
  {
    ...
    produtos: [
      ...
      { id:'am_04_cc_2',  nome:'Copart. Completa — Bronze DF (Apt)',       aco:'apt', tipo:'pme', fvidas:'02-04', valores:[ 239.95, 325.85, 382.52, 382.52, 382.52,  427.27,  590.06,  704.53, 1013.11, 1436.59] },
      { id:'am_04_cc_3',  nome:'Copart. Completa — Prata (Enf)',           aco:'enf', tipo:'pme', fvidas:'02-04', valores:[ 289.90, 339.18, 413.80, 496.56, 521.39,  573.53,  716.91,  788.60,  985.75, 1725.06] },
      { id:'am_04_cc_4',  nome:'Copart. Completa — Prata (Apt)',           aco:'apt', tipo:'pme', fvidas:'02-04', valores:[ 321.80, 376.51, 459.34, 551.21, 578.77,  636.65,  795.81,  875.39, 1094.24, 1914.92] },
      { id:'am_04_cc_5',  nome:'Copart. Completa — Ouro (Enf)',            aco:'enf', tipo:'pme', fvidas:'02-04', valores:[ 323.43, 378.41, 461.66, 553.99, 581.69,  639.86,  799.83,  879.81, 1099.76, 1924.58] },
      { id:'am_04_cc_6',  nome:'Copart. Completa — Ouro (Apt)',            aco:'apt', tipo:'pme', fvidas:'02-04', valores:[ 359.00, 420.03, 512.44, 614.93, 645.68,  710.25,  887.81,  976.59, 1220.74, 2136.30] },
      { id:'am_04_cc_7',  nome:'Copart. Completa — Platinum Mais R1 (Apt)',aco:'apt', tipo:'pme', fvidas:'02-04', valores:[ 473.60, 554.11, 676.01, 811.21, 851.77,  936.95, 1171.19, 1288.31, 1610.39, 2818.18] },
      { id:'am_04_cc_8',  nome:'Copart. Completa — Platinum Mais R2 (Apt)',aco:'apt', tipo:'pme', fvidas:'02-04', valores:[ 478.31, 559.62, 682.74, 819.29, 860.25,  946.28, 1182.85, 1301.14, 1626.43, 2846.25] },
      { id:'am_04_cc_9',  nome:'Copart. Completa — Platinum R1 (Apt)',     aco:'apt', tipo:'pme', fvidas:'02-04', valores:[ 381.07, 445.85, 543.94, 652.73, 685.37,  753.91,  942.39, 1036.63, 1295.79, 2267.63] },
      { id:'am_04_cc_10', nome:'Copart. Completa — Platinum R2 (Apt)',     aco:'apt', tipo:'pme', fvidas:'02-04', valores:[ 384.85, 450.27, 549.33, 659.20, 692.16,  761.38,  951.73, 1046.90, 1308.63, 2290.10] },
      // ── 02–04 vidas · Copart. Parcial (TP) ───────────────────────────
      { id:'am_04_cp_1',  nome:'Copart. Parcial — Bronze DF (Enf)',        aco:'enf', tipo:'pme', fvidas:'02-04', valores:[ 288.23, 391.42, 459.49, 459.49, 459.49,  513.25,  708.80,  846.31, 1216.99, 1725.69] },
      { id:'am_04_cp_2',  nome:'Copart. Parcial — Bronze DF (Apt)',        aco:'apt', tipo:'pme', fvidas:'02-04', valores:[ 319.94, 434.48, 510.04, 510.04, 510.04,  569.71,  786.77,  939.40, 1350.86, 1915.52] },
      { id:'am_04_cp_3',  nome:'Copart. Parcial — Prata (Enf)',            aco:'enf', tipo:'pme', fvidas:'02-04', valores:[ 386.53, 452.24, 551.73, 662.08, 695.18,  764.70,  955.88, 1051.47, 1314.34, 2300.10] },
      { id:'am_04_cp_4',  nome:'Copart. Parcial — Prata (Apt)',            aco:'apt', tipo:'pme', fvidas:'02-04', valores:[ 429.05, 501.99, 612.43, 734.92, 771.67,  848.84, 1061.05, 1167.16, 1458.95, 2553.16] },
      { id:'am_04_cp_5',  nome:'Copart. Parcial — Ouro (Enf)',             aco:'enf', tipo:'pme', fvidas:'02-04', valores:[ 431.23, 504.54, 615.54, 738.65, 775.58,  853.14, 1066.43, 1173.07, 1466.34, 2566.10] },
      { id:'am_04_cp_6',  nome:'Copart. Parcial — Ouro (Apt)',             aco:'apt', tipo:'pme', fvidas:'02-04', valores:[ 478.65, 560.02, 683.22, 819.86, 860.85,  946.94, 1183.68, 1302.05, 1627.56, 2848.23] },
      { id:'am_04_cp_7',  nome:'Copart. Parcial — Platinum Mais R1 (Apt)',aco:'apt',  tipo:'pme', fvidas:'02-04', valores:[ 631.44, 738.78, 901.31,1081.57,1135.65, 1249.22, 1561.53, 1717.68, 2147.10, 3757.43] },
      { id:'am_04_cp_8',  nome:'Copart. Parcial — Platinum Mais R2 (Apt)',aco:'apt',  tipo:'pme', fvidas:'02-04', valores:[ 637.73, 746.14, 910.29,1092.35,1146.97, 1261.67, 1577.09, 1734.80, 2168.50, 3794.88] },
      { id:'am_04_cp_9',  nome:'Copart. Parcial — Platinum R1 (Apt)',      aco:'apt', tipo:'pme', fvidas:'02-04', valores:[ 508.08, 594.45, 725.23, 870.28, 913.79, 1005.17, 1256.46, 1382.11, 1727.64, 3023.37] },
      { id:'am_04_cp_10', nome:'Copart. Parcial — Platinum R2 (Apt)',      aco:'apt', tipo:'pme', fvidas:'02-04', valores:[ 513.13, 600.36, 732.44, 878.93, 922.88, 1015.17, 1268.96, 1395.86, 1744.83, 3053.45] },
      // ── 05–29 vidas · Copart. Completa (30%) ──────────────────────────
      { id:'am_29_cc_1',  nome:'Copart. Completa — Bronze DF (Enf)',       aco:'enf', tipo:'pme', fvidas:'05-29', valores:[ 216.17, 293.56, 344.61, 344.61, 344.61,  384.93,  531.59,  634.72,  912.73, 1294.25] },
      { id:'am_29_cc_2',  nome:'Copart. Completa — Bronze DF (Apt)',       aco:'apt', tipo:'pme', fvidas:'05-29', valores:[ 239.95, 325.85, 382.52, 382.52, 382.52,  427.27,  590.06,  704.53, 1013.11, 1436.59] },
      { id:'am_29_cc_3',  nome:'Copart. Completa — Prata (Enf)',           aco:'enf', tipo:'pme', fvidas:'05-29', valores:[ 260.74, 305.07, 372.19, 446.63, 468.96,  515.86,  644.83,  709.31,  886.64, 1551.62] },
      { id:'am_29_cc_4',  nome:'Copart. Completa — Prata (Apt)',           aco:'apt', tipo:'pme', fvidas:'05-29', valores:[ 289.43, 338.63, 413.13, 495.76, 520.55,  572.61,  715.76,  787.34,  984.18, 1722.32] },
      { id:'am_29_cc_5',  nome:'Copart. Completa — Ouro (Enf)',            aco:'enf', tipo:'pme', fvidas:'05-29', valores:[ 290.89, 340.34, 415.21, 498.25, 523.16,  575.48,  719.35,  791.29,  989.11, 1730.94] },
      { id:'am_29_cc_6',  nome:'Copart. Completa — Ouro (Apt)',            aco:'apt', tipo:'pme', fvidas:'05-29', valores:[ 322.88, 377.77, 460.88, 553.06, 580.71,  638.78,  798.48,  878.33, 1097.91, 1921.34] },
      { id:'am_29_cc_7',  nome:'Copart. Completa — Platinum Mais R1 (Apt)',aco:'apt', tipo:'pme', fvidas:'05-29', valores:[ 425.96, 498.37, 608.01, 729.61, 766.09,  842.70, 1053.38, 1158.72, 1448.40, 2534.70] },
      { id:'am_29_cc_8',  nome:'Copart. Completa — Platinum Mais R2 (Apt)',aco:'apt', tipo:'pme', fvidas:'05-29', valores:[ 430.19, 503.32, 614.05, 736.86, 773.70,  851.07, 1063.84, 1170.22, 1462.78, 2559.87] },
      { id:'am_29_cc_9',  nome:'Copart. Completa — Platinum R1 (Apt)',     aco:'apt', tipo:'pme', fvidas:'05-29', valores:[ 342.73, 400.99, 489.21, 587.05, 616.40,  678.04,  847.55,  932.31, 1165.39, 2039.43] },
      { id:'am_29_cc_10', nome:'Copart. Completa — Platinum R2 (Apt)',     aco:'apt', tipo:'pme', fvidas:'05-29', valores:[ 346.13, 404.97, 494.06, 592.87, 622.51,  684.76,  855.95,  941.55, 1176.94, 2059.65] },
      // ── 05–29 vidas · Copart. Parcial (TP) ───────────────────────────
      { id:'am_29_cp_1',  nome:'Copart. Parcial — Bronze DF (Enf)',        aco:'enf', tipo:'pme', fvidas:'05-29', valores:[ 288.23, 391.42, 459.49, 459.49, 459.49,  513.25,  708.80,  846.31, 1216.99, 1725.69] },
      { id:'am_29_cp_2',  nome:'Copart. Parcial — Bronze DF (Apt)',        aco:'apt', tipo:'pme', fvidas:'05-29', valores:[ 319.94, 434.48, 510.04, 510.04, 510.04,  569.71,  786.77,  939.40, 1350.86, 1915.52] },
      { id:'am_29_cp_3',  nome:'Copart. Parcial — Prata (Enf)',            aco:'enf', tipo:'pme', fvidas:'05-29', valores:[ 347.65, 406.75, 496.24, 595.49, 625.26,  687.79,  859.74,  945.71, 1182.14, 2068.75] },
      { id:'am_29_cp_4',  nome:'Copart. Parcial — Prata (Apt)',            aco:'apt', tipo:'pme', fvidas:'05-29', valores:[ 385.89, 451.49, 550.82, 660.98, 694.03,  763.43,  954.29, 1049.72, 1312.15, 2296.26] },
      { id:'am_29_cp_5',  nome:'Copart. Parcial — Ouro (Enf)',             aco:'enf', tipo:'pme', fvidas:'05-29', valores:[ 387.85, 453.78, 553.61, 664.33, 697.55,  767.31,  959.14, 1055.05, 1318.81, 2307.92] },
      { id:'am_29_cp_6',  nome:'Copart. Parcial — Ouro (Apt)',             aco:'apt', tipo:'pme', fvidas:'05-29', valores:[ 430.50, 503.69, 614.50, 737.40, 774.27,  851.70, 1064.63, 1171.09, 1463.86, 2561.76] },
      { id:'am_29_cp_7',  nome:'Copart. Parcial — Platinum Mais R1 (Apt)',aco:'apt',  tipo:'pme', fvidas:'05-29', valores:[ 567.92, 664.47, 810.65, 972.78,1021.42, 1123.56, 1404.45, 1544.90, 1931.13, 3379.48] },
      { id:'am_29_cp_8',  nome:'Copart. Parcial — Platinum Mais R2 (Apt)',aco:'apt',  tipo:'pme', fvidas:'05-29', valores:[ 573.57, 671.08, 818.72, 982.46,1031.58, 1134.74, 1418.43, 1560.27, 1950.34, 3413.10] },
      { id:'am_29_cp_9',  nome:'Copart. Parcial — Platinum R1 (Apt)',      aco:'apt', tipo:'pme', fvidas:'05-29', valores:[ 456.97, 534.65, 652.27, 782.72, 821.86,  904.05, 1130.06, 1243.07, 1553.84, 2719.22] },
      { id:'am_29_cp_10', nome:'Copart. Parcial — Platinum R2 (Apt)',      aco:'apt', tipo:'pme', fvidas:'05-29', valores:[ 461.51, 539.97, 658.76, 790.51, 830.04,  913.04, 1141.30, 1255.43, 1569.29, 2746.26] },
      // ── 30–99 vidas · Copart. Completa (30%) — Compulsório ────────────
      { id:'am_99_cc_1',  nome:'Copart. Completa — Bronze DF (Enf)',       aco:'enf', tipo:'pme', fvidas:'30-99', valores:[ 197.16, 267.74, 314.30, 314.30, 314.30,  351.07,  484.83,  578.89,  832.44, 1180.40] },
      { id:'am_99_cc_2',  nome:'Copart. Completa — Bronze DF (Apt)',       aco:'apt', tipo:'pme', fvidas:'30-99', valores:[ 218.85, 297.20, 348.88, 348.88, 348.88,  389.70,  538.18,  642.59,  924.04, 1310.29] },
      { id:'am_99_cc_3',  nome:'Copart. Completa — Prata (Enf)',           aco:'enf', tipo:'pme', fvidas:'30-99', valores:[ 253.09, 296.12, 361.27, 433.52, 455.20,  500.72,  625.90,  688.49,  860.61, 1506.07] },
      { id:'am_99_cc_4',  nome:'Copart. Completa — Prata (Apt)',           aco:'apt', tipo:'pme', fvidas:'30-99', valores:[ 280.94, 328.70, 401.01, 481.21, 505.27,  555.80,  694.75,  764.23,  955.29, 1671.76] },
      { id:'am_99_cc_5',  nome:'Copart. Completa — Ouro (Enf)',            aco:'enf', tipo:'pme', fvidas:'30-99', valores:[ 282.36, 330.36, 403.04, 483.65, 507.83,  558.61,  698.26,  768.09,  960.11, 1680.19] },
      { id:'am_99_cc_6',  nome:'Copart. Completa — Ouro (Apt)',            aco:'apt', tipo:'pme', fvidas:'30-99', valores:[ 313.42, 366.70, 447.37, 536.84, 563.68,  620.05,  775.06,  852.57, 1065.71, 1864.99] },
      { id:'am_99_cc_7',  nome:'Copart. Completa — Platinum Mais R1 (Apt)',aco:'apt', tipo:'pme', fvidas:'30-99', valores:[ 413.47, 483.76, 590.19, 708.23, 743.64,  818.00, 1022.50, 1124.75, 1405.94, 2460.40] },
      { id:'am_99_cc_8',  nome:'Copart. Completa — Platinum Mais R2 (Apt)',aco:'apt', tipo:'pme', fvidas:'30-99', valores:[ 417.58, 488.57, 596.06, 715.27, 751.03,  826.13, 1032.66, 1135.93, 1419.91, 2484.84] },
      { id:'am_99_cc_9',  nome:'Copart. Completa — Platinum R1 (Apt)',     aco:'apt', tipo:'pme', fvidas:'30-99', valores:[ 332.69, 389.25, 474.89, 569.87, 598.36,  658.20,  822.75,  905.03, 1131.29, 1979.76] },
      { id:'am_99_cc_10', nome:'Copart. Completa — Platinum R2 (Apt)',     aco:'apt', tipo:'pme', fvidas:'30-99', valores:[ 335.99, 393.11, 479.59, 575.51, 604.29,  664.72,  830.90,  913.99, 1142.49, 1999.36] },
      // ── 30–99 vidas · Copart. Parcial (TP) — Compulsório ─────────────
      { id:'am_99_cp_1',  nome:'Copart. Parcial — Bronze DF (Enf)',        aco:'enf', tipo:'pme', fvidas:'30-99', valores:[ 262.88, 356.99, 419.07, 419.07, 419.07,  468.10,  646.45,  771.86, 1109.93, 1573.88] },
      { id:'am_99_cp_2',  nome:'Copart. Parcial — Bronze DF (Apt)',        aco:'apt', tipo:'pme', fvidas:'30-99', valores:[ 291.80, 396.26, 465.17, 465.17, 465.17,  519.59,  717.55,  856.75, 1232.01, 1746.99] },
      { id:'am_99_cp_3',  nome:'Copart. Parcial — Prata (Enf)',            aco:'enf', tipo:'pme', fvidas:'30-99', valores:[ 337.45, 394.82, 481.68, 578.02, 606.92,  667.61,  834.51,  917.96, 1147.45, 2008.04] },
      { id:'am_99_cp_4',  nome:'Copart. Parcial — Prata (Apt)',            aco:'apt', tipo:'pme', fvidas:'30-99', valores:[ 374.57, 438.25, 534.67, 641.60, 673.68,  741.05,  926.31, 1018.94, 1273.68, 2228.94] },
      { id:'am_99_cp_5',  nome:'Copart. Parcial — Ouro (Enf)',             aco:'enf', tipo:'pme', fvidas:'30-99', valores:[ 376.48, 440.48, 537.39, 644.87, 677.11,  744.82,  931.03, 1024.13, 1280.16, 2240.28] },
      { id:'am_99_cp_6',  nome:'Copart. Parcial — Ouro (Apt)',             aco:'apt', tipo:'pme', fvidas:'30-99', valores:[ 417.88, 488.92, 596.48, 715.78, 751.57,  826.73, 1033.41, 1136.75, 1420.94, 2486.65] },
      { id:'am_99_cp_7',  nome:'Copart. Parcial — Platinum Mais R1 (Apt)',aco:'apt',  tipo:'pme', fvidas:'30-99', valores:[ 551.27, 644.99, 786.89, 944.27, 991.48, 1090.63, 1363.29, 1499.62, 1874.53, 3280.43] },
  ...
  // ── BEST SÊNIOR ───────────────────────────────────────────────────────
  {
    ...
    produtos: [
      { id:'bse_pf1', nome:'Sem copart — Classic (Enf)',    aco:'enf', tipo:'pf',  valores:[0,0,0,0,0,0,  676.09,  851.88, 1090.40, 1504.75] },
      { id:'bse_pf2', nome:'Sem copart — Classic (Apt)',    aco:'apt', tipo:'pf',  valores:[0,0,0,0,0,0,  829.65, 1045.37, 1338.07, 1846.54] },
      { id:'bse_pf3', nome:'Sem copart — Prime (Apt)',      aco:'apt', tipo:'pf',  valores:[0,0,0,0,0,0,  982.49, 1237.94, 1584.56, 2186.69] },
      { id:'bse_pf4', nome:'Sem copart — Platinum (Apt)',   aco:'apt', tipo:'pf',  valores:[0,0,0,0,0,0, 1189.90, 1499.28, 1919.08, 2648.33] },
      { id:'bse_pme1', nome:'Sem copart — Classic PJ (Enf)',aco:'enf', tipo:'pme', valores:[0,0,0,0,0,0,  608.48,  766.69,  981.36, 1353.64] },
      { id:'bse_pme2', nome:'Sem copart — Classic PJ (Apt)',aco:'apt', tipo:'pme', valores:[0,0,0,0,0,0,  746.69,  940.84, 1204.26, 1661.89] },
      { id:'bse_pme3', nome:'Sem copart — Prime PJ (Apt)',  aco:'apt', tipo:'pme', valores:[0,0,0,0,0,0,  884.24, 1114.15, 1426.10, 1968.02] },
      { id:'bse_pme4', nome:'Sem copart — Platinum PJ (Apt)',aco:'apt',tipo:'pme', valores:[0,0,0,0,0,0, 1070.91, 1349.36, 1727.17, 2383.50] },
    ]
  },
